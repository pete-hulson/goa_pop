...
// Output file (.rep) which is loaded into R for data outputs
  ...
  for (i=1;i<=nyrs_fish_age;i++) report <<yrs_fish_age(i)<<" "<<nmulti_fish_age(i)<<" "<<effn_fish_age(i)<<" "<<sdnr_fish_age(i)<<endl; report<<"#!!"<<endl; report<<endl;
  ...
  for (i=1;i<=nyrs_fish_size;i++) report <<yrs_fish_size(i)<<" "<<nmulti_fish_size(i)<<" "<<effn_fish_size(i)<<" "<<sdnr_fish_size(i)<<endl; report<<"#!!"<<endl; report<<endl;
  ...
  for (i=1;i<=nyrs_srv1_age;i++) report <<yrs_srv1_age(i)<<" "<<nmulti_srv1_age(i)<<" "<<effn_srv1_age(i)<<" "<<sdnr_srv1_age(i)<<endl; report<<"#!!"<<endl; report<<endl;
