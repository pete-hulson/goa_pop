...
// Bottom trawl survey size composition data
  ...
  vector               nmulti_srv1_size(1,nyrs_srv1_size)      // Input N for survey 1 size
...
// Predicted Survey1 size comps, N, effn, sdnr, and offset
  for (i=1;i<=nyrs_srv1_size;i++) {
   ...
   nmulti_srv1_size(i) = sqrt(nsamples_srv1_size(i));   
   effn_srv1_size(i) = (1-esc_srv1(i))*esc_srv1(i)/norm2(osc_srv1(i)-esc_srv1(i));
   sdnr_srv1_size(i) = sdnr(esc_srv1(i),osc_srv1(i),double(nmulti_srv1_size(i)));
  }
  for (i=1; i<=nyrs_srv1_size; i++) {
...
// Output file (.rep) which is loaded into R for data outputs
  ...
  report << "yrs_srv1_size nmulti_srv1_size effn_srv1_size sdnr_srv1_size" <<endl;
  for (i=1;i<=nyrs_srv1_size;i++) report <<yrs_srv1_size(i)<<" "<<nmulti_srv1_size(i)<<" "<<effn_srv1_size(i)<<" "<<sdnr_srv1_size(i)<<endl; report<<endl;
