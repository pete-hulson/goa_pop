...
names(qvals) <- basename(mod_alts);qvals
mvals <- biglist$pars[grep('NatM',biglist$pars$Label),]
...
geom_point(data = subset(modsi, model == 'model1'), 
...
ggsave(ptsurv,file = here(year,'ss','v-300.00','surv_compare_pt.png'))
...
scale_color_manual(values = colvec[c(2:7,1)],
