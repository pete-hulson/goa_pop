...
//==============================================================================================================================
  ...
  mean_recdev_like = norm2(mean_rec_dev)/(2*square(cvmean_rec_dev));
...
// Output file (.rep) which is loaded into R for data outputs
  ...
  report << wt_recdev <<" "<<mean_recdev_like     <<" " ; report << "Mean Recruitment Deviations Likelihood" << endl;
