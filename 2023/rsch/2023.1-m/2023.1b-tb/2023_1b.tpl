...
//==============================================================================================================================
  ...
  for (i = 2012; i <= endyr; i++)
    natmort(i) = mfexp(logm2);                                      // setting natural mortality to arithmetic scale
...
// Calculate prior penalties
    ...
    if (active(logm1))
      priors(3)    = square(logm1-log(mprior))/(2.*square(cvmprior)) + square(logm2-log(mprior))/(2.*square(cvmprior));
...
// Output file (.rep) which is loaded into R for data outputs
  ...
  report<<"   q_trawl   "<<endl;
  report<<q_srv1<<endl;
  report<<"   nat_mort (styr-2011)  "<<endl;
  report<<mfexp(logm1)<<endl;
  report<<"   nat_mort (2012-endyr)  "<<endl;
