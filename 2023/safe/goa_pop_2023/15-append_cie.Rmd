...
```{r, fig.cap = "Size-at-age probability matrices for each fleet. The matrix on the right is used for all data in the base model.", out.width="50%",out.height="50%"}
knitr::include_graphics(here::here('goa_pop','2021_cie','cie_1_waa','saa_matrices_compare.png'))
```


```{r, fig.cap = "Biomass trajectory comparison between the base model, a model using a separate size-at-age matrix for the fishery data from 1980 onwards ('separateSAA'), and a model using the fishery-derived weight-at-age vector for all population dynamics ('newWAA').", out.width="50%",out.height="50%"}
