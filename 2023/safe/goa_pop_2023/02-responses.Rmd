...
POP biomass estimates from the hydro-acoustic survey are availble from 2013 onwards. The authors have elected to continue reporting these values in the SAFE for for full operational assessments; as in 2021 these data are not included in the base model. This data source will be considered as POP is transitioned to a new modeling framework by a new author in subsequent cycles.
