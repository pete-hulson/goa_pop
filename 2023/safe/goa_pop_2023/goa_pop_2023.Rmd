...
Kapur, M., Hulson, P-J., Williams, B., 2023. Assessment of the Pacific Ocean Perch Stock in the Gulf of Alaska. North Pacific Fishery Management Council, Anchorage, AK. Available from https://www.npfmc.org/library/safe-reports/
...
ofl_23 = 8000 # placeholder while i figure things out
b35_23 = 10000 # aka MSST
ssb_23 <- 10000 # current s biomass
tb_23 <- 100000 # total biomass
abc_22 <- 36196; abc_22p <- prettyNum(abc_22,big.mark=',') ## 2022 model's ABC for 2024
abc_23 <- 40185 ## this year's ABC for 2024
abc<-prettyNum(round(abc_23,1),big.mark=',')
yld_rat <- read.csv(here::here(year,'mgmt',model,'procesed'))
## catch in 2022
...
mdlres <- list.files(here(year,'mgmt',model,'processed'), pattern = '.csv', full.names = TRUE)
