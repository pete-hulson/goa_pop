...
```{r survey, fig.cap="NMFS Groundfish Survey observed biomass estimates (points) with 95% sampling error confidence intervals for GOA POP (vertical bars). Model estimates are shown in black.", eval = TRUE}
