...
| $F_{40\%}$       | The fishing mortality rate that reduces the equilibrium level of spawning per recruit to 40% of the level that would be obtained in the absence of fishing | `r prettyNum(execsumm[1,'f_abc'],big.mark =',')`    |
| ABC             | Yield at $F_{40\%}$ in 2024                                                                                                                                       | `r prettyNum(abc_24,big.mark =',')` t |
| $F_{35\%}$       | The fishing mortality rate that reduces the equilibrium level of spawning per recruit to 35% of the level that would be obtained in the absence of fishing |`r prettyNum(execsumm[1,'f_ofl'],big.mark =',')`    |
