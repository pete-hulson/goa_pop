...
flextable::regulartable(read.csv(here::here(year, 'data','output','fsh_length_comp.csv')) %>% 
                          ...
                          tidyr::pivot_wider(
                            ...
                            names_glue = "{year} ({n_h})",
                            values_from = value)) %>%
  flextable::set_caption("Fishery length frequency data for POP in the GOA for the most recent 10 complete years used in the model. Input sample sizes (sqaure root of nominal sample size scaled with a maximum of 100) are in parentheses.") %>%
