...
psc <- read.csv(here(year,'data','output','psc_catch.csv')) %>% select(species, X2019,X2020,X2021,X2022,X2023)

psc[1:nrow(psc),2:6] <- round(psc[1:nrow(psc),2:6]/1000,2)

flextable::regulartable(psc ) %>%  
      flextable::set_caption("Prohibited Species Catch (PSC) estimates reported in tons for halibut and herring, and thousands of animals for crab and salmon, by year, for the GOA rockfish fishery. Source: NMFS AKRO Blend/Catch Accounting System PSCNQ via AKFIN through 9/11/2023.") %>%

  flextable::set_header_labels(species = 'Species Group Name', X2019='2019',X2020='2020',X2021 = '2021', X2022 = '2022', X2023='2023') 
```
