...
*Changes in the input data*: We updated the catch for `r year-1` and used preliminary catch estimates for `r paste0(c(2023,2025),collapse = '-')` (see Specified catch estimation section), along with `r year` bottom trawl survey biomass, and 2020 fishery age composition. 
