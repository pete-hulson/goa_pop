...
*Changes in the input data*: This assessment includes updated catch for `r year-1`, assumed catches of `r prettyNum(c1, big.mark = ',')` t for `r year`, `r prettyNum(c2, big.mark = ',')` t for `r year+1` and `r prettyNum(c3, big.mark = ',')` t for `r year+2` (see [How Future Catch is Specified](#authorsF) for details). Additional data additions include bottom trawl survey biomass through `r year`, fishery age composition data through 2022, and survey age composition data through 2021.  
