...
An exploratory model was run wherein the 2021 size-at-age probability matrix for 1980-present was used instead of the updated matrix; estimated female spawning biomass and total (2+ biomass) for `r year+1` varied by less than `r max(c(round(100*(227991-227630)/227991,2),round(100*(649941-649010)/649941,2)))`%.
...
time-blocked into four periods, corresponding with large-scale changes in the fishery and management structure (Table 10.\@ref(tab:mgmtmeasures)). The period from 1961-1976 is asymptotic
